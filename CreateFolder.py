...
if __name__ == '__main__':
	...
	parser.add_argument('--vocab_path', type=str,
						default='/home/user_data55/maz/mahc/data/vocab.pkl',
						help="Storage path of vocabulary")

	parser.add_argument('--train_image_dir', type=str,
						default='/home/user_data55/maz/cocodata/train2014',
						help="Image path of training data set")

	parser.add_argument('--train_caption_path', type=str,
						default='/home/user_data55/maz/cocodata/annotations/captions_train2014.json',
						help="Caption path of training data set")

	parser.add_argument('--val_image_dir', type=str,
						default='/home/user_data55/maz/cocodata/val2014',
						help="Image path of validation set")

	parser.add_argument('--val_caption_path', type=str,
						default='/home/user_data55/maz/cocodata/annotations/captions_val2014.json',
